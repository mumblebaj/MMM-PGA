...
`largerFonts`| Whether to display larger fonts for the module. If set to false it will use the `xsmall` style define by MagicMirror. If set to true it will use the `small` style defined by MagicMirror. <br><br>Type: `Boolean`<br>Defaults to false
...
`rapidAPIKey`| Your RapidAPI key, necessary if you want to display FEDEXCUP and OWGR standings.<br>Type: String<br>Defaults to null
